...
#
# Init setup file
# Created by Genus(TM) Synthesis Solution on 09/02/2025 14:28:21
#
################################################################################
if { ![is_common_ui_mode] } { error "ERROR: This script requires common_ui to be active."}

read_mmmc /data/project/tsmc65/users/moryoav/ws/Project/aes-128/ws1/../export/pwr/genus/aes_128.mmmc.tcl
...
read_netlist /data/project/tsmc65/users/moryoav/ws/Project/aes-128/ws1/../export/pwr/genus/aes_128.v
