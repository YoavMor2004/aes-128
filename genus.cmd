...
xrun -64bit -sv -timescale 1ns/1ps \
  +define+GATE_LEVEL +define+BACKANNOTATION \
  outputs/exports/post_synth/aes_128_gate.v tb_glv_aes.sv \
  +SETTLE=120 -l glv_xcelium.log
xrun -64bit -sv -timescale 1ns/1ps \
  +define+GATE_LEVEL +define+BACKANNOTATION +define+HAS_CLK \
  outputs/exports/post_synth/aes_128_gate.v tb_glv_aes.sv \
  +CLKPERIOD_NS=10.0 -l glv_xcelium.log
exit
